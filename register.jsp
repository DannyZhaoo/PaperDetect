  ...
  <div class="pagecontent">
    ...
    <div class="login-wrapper">
      <form action="#">
        ...
        <select name="" id="classEdition" style="width: 100%;text-align: center;font-size: 15px;margin-bottom: 20px;">
          <option value="软件学院" style="text-align: center;">软件学院</option>
        ...
        <select id="myclass" style="width: 100%;text-align: center;font-size: 15px;margin-bottom: 20px;">
          <option value="2015级" style="text-align:center;">2015级</option>
