...
<body>
  <div class="pagecontent">
    ...
    <div id="container">
      <div id="subheader">&nbsp&nbsp非官方测试版</div>
      <!-- Nav tabs -->
      ...
      <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active" id="home">
          ...
          <div style="width:40%;margin-left: 30px;float:left;margin-top:10px;height:188px;border:0px solid rgb(200,200,200);border-radius:4px;font-family: "Gill Sans Extrabold", Helvetica, sans-serif;">
            &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp本网站旨在提供大连理工大学本科毕业论文格式规范性保障服务，为毕业生免费检测毕业论文格式，并提供检测报告。系统尚处在初期阶段，项目团队正在夜以继日更新完善系统，随时提供更新版本，详细功能和版本历史请见右侧说明文字。<b>非常希望能得到您的反馈意见！请点击右上角“反馈意见”链接。</b>本网站目前支持的浏览器(包括但不限于)：<br/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1.&nbsp&nbsp360安全浏览器8&nbsp&nbsp
            <br/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp2.&nbsp&nbspIE11&nbsp&nbsp<br/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp3.&nbsp&nbspChrome31&nbsp&nbsp<br/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp4.&nbsp&nbspfirefox27.0.1&nbsp&nbsp
          ...
          <div  class="modal-dialog" style="width:100%;">
            <div class="modal-content" style="width: 80%; margin: auto;">
              <div class="modal-body" id="report-text">
                  <h3 style='text-align:center;'>请先上传毕业论文或从检测历史中选择一项查看检测报告!</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div role="tabpanel" class="tab-pane" id="profile" style="height: auto;">
          <div id="ziliao">
            ...
            <br/>
            <div style="margin-top:15px;"><span style="width:15px;clear:left;"><img src="images/class.png" style="width:20px;height:20px;"></span><span style="line-height: 20px;">班级</span><span id="st_class"></span></div>
            <br/>
