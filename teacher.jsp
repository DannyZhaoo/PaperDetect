...
<body>
  <div class="pagecontent">
    ...
    <div id="container">
      <div id="subheader">&nbsp&nbsp&nbsp&nbsp非官方测试版</div>
...
<div id="myModal" class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <label for="exampleInputPassword1" style="display: block;">开始时间</label>
    <input type="text" class="form-control" id="start" value="2016-6-5" style="width: 90%;display: inline-block;clear:left;">
  </div>
          <div class="form-group">
    <label for="exampleInputPassword1" style="display: block;">结束时间</label>
    <input type="text" class="form-control" id="end"     value="2016-6-5" style="width: 90%;display: inline-block;clear:left;">
  </div>
      ...
      <div class="modal-footer">
        ...
        <input id="time" type="button" class="btn btn-primary" value="确定" onclick="search_01(4,encodeURI($('#start').val())+' '+encodeURI($('#end').val()));$('#myModal').modal('hide');">
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
